...
import styles from "./HatThemeSelector.module.css";

export interface HatThemeSelectorProps {
  themes: readonly HatTheme[];
  selectedIds: readonly string[];
  onToggle: (themeId: string) => void;
}

export function HatThemeSelector({ themes, selectedIds, onToggle }: HatThemeSelectorProps) {
  return (
    <fieldset className={styles.root}>
      <legend className={styles.legend}>Темы</legend>
      <p className={styles.hint}>Можно смешать несколько наборов в одной шляпе.</p>
